...
The payoff is not that the learned simulator is *better* than MuJoCo. It never will be. The payoff is that it is *differentiable*, *fast to roll out*, and *yours*. In 3.2 you'll train a policy entirely inside it, never touching the real env during learning.
