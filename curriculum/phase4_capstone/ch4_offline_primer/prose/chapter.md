# Offline RL Primer: Beat the Data With Its Own Reward
...
on a tiny free-tier budget, not a leaderboard entry. And BC does not improve much
...
The capstone's RL post-training (4.3, HIL-SERL) fine-tunes an RL policy starting
