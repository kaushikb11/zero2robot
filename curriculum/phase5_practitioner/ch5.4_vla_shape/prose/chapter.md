...
That collapse is byte-reproducible and seed-robust (a flow-MSE gap of +0.55 to +1.0 across seeds
...
ch1.6) and it **floors at zero for both masks** — a from-scratch tiny two-tower on a frozen random
vision backbone cannot drive PushT any more than ch1.8's could. We report it plainly and gate
nothing on it.
